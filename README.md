...
- Import all the data from the data repository: `php bin/console app:import:std path_to_json_repository`
...
- `php bin/console nrdb:highlight decklist_id` 
...
- run `php bin/console nrdb:import:json path_to_json_repository`
